...
class AdvancedEagleEyeLLM(transformers.AutoModelForSeq2SeqLM):
    ...
    def forward(self, input_ids, attention_mask=None, **kwargs):
        ...
        decoder_outputs = self.decoder(
            ...
            internet_knowledge_hidden_states=internet_knowledge_hidden_states,
            movie_knowledge_hidden_states=movie_knowledge_hidden_states,
        )
        ...
        return logits, encoder_hidden_states, decoder_hidden_states, memory_hidden_states
